...
nit*/
        ...
        public OdbcDataReader Consultameta()
        {
            ...
            {
                cn.conexionbd();
                string consulta = "SELECT * FROM meta WHERE estado = 1; ";
                comm = new OdbcCommand(consulta, cn.conexionbd());
                OdbcDataReader mostrar = comm.ExecuteReader();
                return mostrar;
            }
        ...
        public OdbcDataReader InsertarEvaluacion(string pkcodigokpi, string fechadeasignacion, string puntuacion, string fkcodigoempleado, string fkcodigo_meta, string estado_completado, string fecha_realizacion)
        {
            ...
            {
                cn.conexionbd();
                string consulta = "INSERT into kpi values (" + pkcodigokpi + ",'" + fechadeasignacion + ",'" + puntuacion + ",'" + fkcodigo_meta + "'" + estado_completado + "'" + fecha_realizacion + "');";
                comm = new OdbcCommand(consulta, cn.conexionbd());
                OdbcDataReader mostrar = comm.ExecuteReader();
                return mostrar;
            }
